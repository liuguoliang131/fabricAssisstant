...
const Product: FC = (): ReactElement => {
    ...
    return (
        <div className="examine">
            ...
            <Header exitHide={true}>检验统计</Header>
                ...
                <div className="tablebox">
                    {
                        ...
                        <div className='table'>
                            <div className="thead">
                                ...
                                <div className="th">合格数量</div>
                                <div className="th">不合格数量</div>
                                    ...
                                    data.data.length > 0 ? (
                                        data.data.map((item, idx) => (
                                            <div className="tr">
                                                ...
                                                <div className="td">{item.repairCount || 0}</div>
                                                <div className="td">{item.noRepairCount || 0}</div>
